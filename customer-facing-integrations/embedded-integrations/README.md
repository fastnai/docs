...
> _Scenario:_ A store owner updates a product title in Shopify → your app detects the change and updates the search index in real time.
...
> _Scenario:_ A merchant sells a product on Shopify → Fastn detects the sale → updates inventory across Amazon and NetSuite automatically.
